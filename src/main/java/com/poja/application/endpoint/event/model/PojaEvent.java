package com.poja.application.endpoint.event.model;

import static com.poja.application.endpoint.event.EventStack.EVENT_STACK_1;
import static java.lang.Math.random;

import com.poja.application.PojaGenerated;
import com.poja.application.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    if (getEventStack().equals(EVENT_STACK_1)) return "com.poja.application.event1";
    return "com.poja.application.event2";
  }
}
