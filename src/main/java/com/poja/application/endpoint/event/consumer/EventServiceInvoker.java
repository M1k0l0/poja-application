package com.poja.application.endpoint.event.consumer;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("com.poja.application.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "com.poja.application.service.event."
