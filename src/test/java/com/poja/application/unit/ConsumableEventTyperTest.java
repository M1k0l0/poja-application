package com.poja.application.unit;
...
import com.poja.application.conf.FacadeIT;
...
import com.poja.application.endpoint.event.consumer.model.TypedEvent;
import com.poja.application.endpoint.event.model.UuidCreated;
...
public class ConsumableEventTyperTest extends FacadeIT {
  ...
  void to_acknowledgeable_typed_event_ok() throws JsonProcessingException {
    ...
    var typedEvent =
        new TypedEvent("com.poja.application.endpoint.event.model.UuidCreated", payload);
